...
namespace Modules\AdminBase\Livewire\Auth;

use Illuminate\Support\Facades\Hash;
use Illuminate\Validation\ValidationException;
use Livewire\Component;
use Modules\AdminBase\Services\OtpService;
...
class PasswordResetWhileDisconnectedForm extends Component
{
    ...
    {
        return view('adminbase::livewire.auth.password-reset-while-disconnected-form');
    }
}
