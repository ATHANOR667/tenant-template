...
class PermissionStats extends Component
{
    ...
    protected function calculateRoleUserCounts(): void
    {
        ...
        foreach ($this->roles as $role) {
            $usersWithRole = app($this->userModelClass)::role($role->name, $this->guardName)->get();
    ...
    public function getPermissionsGroupedByCategoryProperty(): \Illuminate\Support\Collection
    {
        return collect($this->permissionRoleCounts)->groupBy('categorie');
    }
    ...
    {
        return view('adminbase::livewire.gestion-roles.permission-stats');
    }
}
