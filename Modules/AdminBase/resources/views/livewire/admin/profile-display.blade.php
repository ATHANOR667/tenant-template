<div>
    ...
    >
        <div class="flex items-center justify-between cursor-pointer" @click="detailsOpen = !detailsOpen">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">
                Mes Informations Personnelles
            </h2>
            <div class="p-2 rounded-full bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-transform duration-300"
        ...
        <div x-show="detailsOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
             x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95">

            @if ($admin)
                <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    {{-- Colonne du haut: Photos et QR Code --}}
                    ...
                    {{-- Colonne du bas: Infos Générales (Lecture seule) --}}
