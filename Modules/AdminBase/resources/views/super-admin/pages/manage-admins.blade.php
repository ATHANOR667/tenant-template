...
@section('content')
    <div class="space-y-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            ...
            @livewire('adminbase::gestion-roles.manage-roles-permissions', ['guardName' => 'admin'])
            <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                @livewire('adminbase::gestion-roles.permission-stats', ['guardName' => 'admin'])
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            ...
            @livewire('adminbase::super-admin.manage-admins.list-admins')
        </div>
    </div>

    {{-- Modales qui doivent être rendues en dehors du flux principal pour être en surcouche --}}
    @livewire('adminbase::super-admin.manage-admins.create-admin')
    @livewire('adminbase::super-admin.manage-admins.admin-profile-card')
