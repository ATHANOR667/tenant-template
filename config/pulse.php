    ...
    */
    ...
    'recorders' => [
        ...
        Recorders\Servers::class => [
            ...
            /** Dit à Pulse de se limiter au conteneur pour les métriques serveur  */
            'read_cgroup_stats' => true,
        ...
        // recorder pour les dépendances périmées
            ...
            'connections' => [
                'pgsql' => [
                    'values' => [
                        ...
                        'xact_commit',      // Transactions validées
                        'xact_rollback',    // Transactions annulées
                        'blks_read',        // Blocs lus depuis disque
                        'blks_hit',         // Blocs trouvés en cache
                        'tup_returned',     // Lignes retournées
                        'tup_fetched',      // Lignes lues via index
                        'tup_inserted',     // Lignes insérées
                        'tup_updated',      // Lignes mises à jour
                        'tup_deleted',      // Lignes supprimées
                        'conflicts',        // Conflits de verrous
                        'temp_files',       // Fichiers temporaires
                        'temp_bytes',       // Taille totale des fichiers temporaires
                        'deadlocks',        // Blocages détectés
                        'blk_read_time',    // Temps lecture (ms)
                        'blk_write_time',   // Temps écriture (ms)
                    ],
                    'aggregates' => [
                        'avg' => [
                            'numbackends',
